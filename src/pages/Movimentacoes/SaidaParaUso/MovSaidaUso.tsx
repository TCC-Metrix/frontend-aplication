...
export const MovSaidaUso = () => {
  ...
  //Instrumento selecionado no input search filter
  ...
  useEffect(() => {
    console.log("table no useEffect", tableMainPage);
  }, [tableMainPage]);

  //Reseta o instrumento selecionado
  ...
  const resetAllModalData = () => {
    ...
    resetInstrument();
    setTableModalList([]);
    setDropdownSelected("description");
  };
  ...
  const handleButtonConfirmModal = () => {
    ...
    console.log("table modal list: ", tableModalList, "+", repeatedItems);
  ...
  setTimeout(function () {
    console.log("setei na main page, ", tableMainPage);
  }, 2000);
  return (
    <main>
