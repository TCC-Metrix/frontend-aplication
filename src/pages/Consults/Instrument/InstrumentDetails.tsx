				...
				<div className="details-section">
					<div className="detail-area">
						...
						<p className="detail-content">
							{lastMovementData.mov.useOutput
								? formatDate(lastMovementData.mov.useOutput.outputDate)
								: lastMovementData.mov.laboratoryOutput
								? formatDate(lastMovementData.mov.laboratoryOutput.outputDate)
								: "-"}
						</p>
					</div>
					<div className="detail-area">
						...
						<p className="detail-content">
							{lastMovementData.mov.useReturn
								? formatDate(lastMovementData.mov.useReturn.returnDate)
								: "-"}
						</p>{" "}
						{/*//arrumar para o retorno lab depois */}
					</div>
					<div className="detail-area">
					...
					<div className="detail-area">
						...
						<p className="detail-content">
							{lastMovementData.mov.useOutput &&
							lastMovementData.mov.useOutput.receivingResponsible
								? lastMovementData.mov.useOutput.receivingResponsible.name
								: "-"}
						</p>
					</div>
					<div className="detail-area">
						...
						<p className="detail-content">
							{lastMovementData.mov.laboratoryOutput
								? lastMovementData.mov.laboratoryOutput.laboratory.description
								: "-"}
						</p>
					</div>
					<div className="detail-area">
						...
						<p className="detail-content">
							{lastMovementData.mov.useOutput &&
							lastMovementData.mov.useOutput.receivingArea
								? lastMovementData.mov.useOutput.receivingArea.description
								: "-"}
						</p>
					</div>
				</div>
